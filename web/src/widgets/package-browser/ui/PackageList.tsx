...
export function PackageList({ onPackageClick }: PackageListProps) {
  const [packages, isLoading, installProgress, onPackageSelected, onUninstall, onUpdate] = useUnit([
    $filteredInstalledPackages,
    $isLoadingPackages,
    $installProgress,
    packageSelected,
  ...
  const handleUninstall = (e: React.MouseEvent, packageId: string) => {
    e.stopPropagation();
                  ...
                  <Menu shadow="md" width={180} position="bottom-end">
                    ...
                    <Menu.Dropdown>
                      ...
                      <Menu.Item
                        ...
                        onClick={(e) => handleUninstall(e, pkg.id)}
                      >
                        Uninstall
                      </Menu.Item>
                    </Menu.Dropdown>
